...
/**
 * A receiver-initiated (pull) connection.
 */
public class RTMPPullSessionListener extends SessionListener {
    ...
    public void play(String name) {
        if (this.rtmp.state != RTMPState.AUTHENTICATING) {
